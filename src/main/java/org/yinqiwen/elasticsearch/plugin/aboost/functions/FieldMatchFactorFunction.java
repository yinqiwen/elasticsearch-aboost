 ...
 */
public class FieldMatchFactorFunction extends ScoreFunction {
	private static final Logger logger = ESLoggerFactory.getLogger(FieldMatchFactorFunction.class.getName());
    ...
    public FieldMatchFactorFunction(String field,String match, float boostFactor, Modifier modifierType, Double missing,
    ...
    protected boolean doEquals(ScoreFunction other) {
    	FieldMatchFactorFunction fieldValueFactorFunction = (FieldMatchFactorFunction) other;
